 ...
 * @generated
 */
public class PartsLocalServiceClp implements PartsLocalService {
    ...
    public PartsLocalServiceClp(InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addParts";

        _methodParameterTypes0 = new String[] { "com.example.plugins.model.Parts" };
        ...
        _methodParameterTypes3 = new String[] { "com.example.plugins.model.Parts" };
        ...
        _methodName10 = "fetchParts";

        _methodParameterTypes10 = new String[] { "long" };

        _methodName11 = "getParts";
        ...
        _methodName13 = "getPartses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getPartsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateParts";

        _methodParameterTypes15 = new String[] { "com.example.plugins.model.Parts" };
    ...
    public com.example.plugins.model.Parts addParts(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(parts) });
        } catch (Throwable t) {
        ...
        return (com.example.plugins.model.Parts) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.example.plugins.model.Parts> getPartses(
        ...
        return (java.util.List<com.example.plugins.model.Parts>) ClpSerializer.translateOutput(returnObj);
    }
